        ...
        <div class="row justify-content-center">
              {{-- Panel de botones --}}
                <div class="links">
                    ...
                    {{-- Gastos --}}
                    <a class="btn btn-outline-success  btn-lg" role="button"  href="{{ url('/admin/gasto/gasto') }}"> 
