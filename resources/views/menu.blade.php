...
<div class="container">
   ...
   {{-- Panel de botones --}}
                    {{-- Pedidos --}}
                    <a class="btn btn-info  btn-lg" role="button" href="{{ url('/admin/pedidos') }}">
                        <img src="{{asset('img/realiza_pedido.png')}}" width="100" /><br>
                        <span class="label label-default">Pedido </span> </a> 
                    {{-- Productos--}}
                     <a class="btn btn-warning  btn-lg" role="button" href="{{ url('admin/producto/producto') }}">
                        <img src="{{asset('img/easter-egg-bunny-pattern-icon-68527.png')}}" width="100" /><br>
                        <span class="label label-default">Pedido </span> </a>
                    {{-- Control Stock --}}       
                    <a class="btn btn-danger  btn-lg" role="button"  href="{{ url('/admin/stock/stock') }}"> 
                        <img src="{{asset('img/Control-de-stock.png')}}" width="100" /><br>
                        <span class="label label-default">Control Stock</span></a>
                    {{-- Clientes --}}
                    <a class="btn btn-primary  btn-lg" role="button"  href="{{ url('/admin/cliente/cliente') }}">
